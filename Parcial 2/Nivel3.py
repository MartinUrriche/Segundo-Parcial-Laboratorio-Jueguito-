...
from Class_item import Moneda
from Configuraciones import *
from Modo import *
from Manejo_de_eventos import manejar_eventos_personaje
...
class Nivel3:
    def __init__(self, pantalla, grupo_proyectiles):
        ...
        self.fondo = pygame.image.load(r"Parcial 2\fondo niveles\fondo_3.png").convert()
        self.fondo = pygame.transform.scale(self.fondo, (W, H))

        # Crear plataformas
        self.piso = crear_plataforma(False, (W, 10), 0, 558)
        self.plataforma_movible = Plataforma(True, (70, 60), 520, 460, r"Parcial 2\plataformas\1.png", movible=True, rango_y=(200, 535))
        self.plataforma_movible.ajustar_posicion_inicial(self.piso.rectangulo.top)
        self.plataforma_flotante = crear_plataforma(True, (200, 50), 100, 370, r"Parcial 2\plataformas\2.png")
        self.plataforma_flotante_x = self.plataforma_flotante.rectangulo.x
        self.plataforma_flotante_2 = crear_plataforma(True, (200, 50), 600, 200, r"Parcial 2\plataformas\2.png")
        self.plataforma_flotante_3 = crear_plataforma(True, (200, 50), 300, 200, r"Parcial 2\plataformas\2.png")
        self.plataforma_movible_2 = Plataforma(True, (70, 60), 10, 490, r"Parcial 2\plataformas\1.png", movible=True, rango_y=(360, 550))
        self.plataformas = [self.piso, self.plataforma_movible, self.plataforma_flotante, self.plataforma_flotante_2,
                            self.plataforma_flotante_3,self.plataforma_movible_2]
        ...
        personaje = Personaje(acciones, 5, (55, 45), 100, 515)
        ...
        monedas_flotante_2 = [
            Moneda(self.plataforma_flotante_2.rectangulo.x + 30, self.plataforma_flotante_2.rectangulo.top - 30, puntos=10, imagenes=moneda_img),
            Moneda(self.plataforma_flotante_2.rectangulo.x + 60, self.plataforma_flotante_2.rectangulo.top - 30, puntos=10, imagenes=moneda_img),
            ]
    ...
    def manejar_eventos(self):
        ...
        if self.plataforma_movible.rectangulo.colliderect(self.personaje.rectangulo_pies):
            self.personaje.rectangulo_principal.y += self.plataforma_movible.velocidad
            self.personaje.rectangulo_pies.y += self.plataforma_movible.velocidad
            self.personaje.rectangulo_cabeza.y += self.plataforma_movible.velocidad
            self.personaje.rectangulo_brazo_derecho.y += self.plataforma_movible.velocidad
            self.personaje.rectangulo_brazo_izquierdo.y += self.plataforma_movible.velocidad
        if self.plataforma_movible_2.rectangulo.colliderect(self.personaje.rectangulo_pies):
            self.personaje.rectangulo_principal.y += self.plataforma_movible_2.velocidad
            self.personaje.rectangulo_pies.y += self.plataforma_movible_2.velocidad
            self.personaje.rectangulo_cabeza.y += self.plataforma_movible_2.velocidad
            self.personaje.rectangulo_brazo_derecho.y += self.plataforma_movible_2.velocidad
            self.personaje.rectangulo_brazo_izquierdo.y += self.plataforma_movible_2.velocidad
    ...
    def dibujar(self):
        ...
        self.pantalla.blit(self.plataforma_movible_2.superficie, self.plataforma_movible_2.rectangulo)
        ...
        if not self.juego_pausado:
            ...
            for i in range(len(self.lista_enemigo)):
                if self.lista_enemigo[i].esta_muerto:
                    ...
                    break
        self.plataforma_movible.mover_verticalmente()
        self.plataforma_movible_2.mover_verticalmente()
    ...
    def pasar_nivel(self):
        if len(self.lista_enemigo) == 0:
            # Si no hay enemigos vivos, abrir la puerta
