...
class Nivel2:
    def __init__(self, pantalla, grupo_proyectiles):
        ...
        self.fondo = pygame.image.load(r"Parcial 2\fondo niveles\fondo_nivel2.png").convert()
        ...
        self.plataformas = [self.piso, self.plataforma_movible, self.plataforma_flotante, self.plataforma_flotante_2,self.plataforma_flotante_3]
        ...
        personaje = Personaje(acciones, 5, (55, 45), 100, 475)
